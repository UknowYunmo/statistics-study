"""
표본의 비교에는 크게 5가지로 나눌 수 있다.

 a. 소표본에서 모분산이 동일한 경우의 독립표본
 b. 대표본에서 독립표본
 c. 소표본에서 모분산이 다른 경우의 독립표본
 d. 대응표본
 e. 독립표본의 모비율
 
c는 a와 별 차이 없다고 생각할 수 있지만
자유도를 n1+n2-2로 구하지 않고
자유도를 구하는 공식이 별도로 있기 때문에
t 검정할 때 기각역이 달라지니 유의하자
"""
